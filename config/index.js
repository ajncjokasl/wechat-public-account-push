export const config = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  // APP_ID: "wxf1c6a5a8428a488a",

  // 公众号APP_SECRET 
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  // APP_SECRET: "d684d3fef1fa8476d089b753716038ac",
   ...
   */
  FESTIVALS: [
    {"type": "生日", "name": "王婵宝贝", "year": "1998", "date": "05-29"},
    {"type": "节日", "name": "在一起", "year": "2022", "date": "01-14"},
    {"type": "节日", "name": "新年", "year": "2023", "date": "02-01"},
    {"type": "生日", "name": "刘子涵", "year": "2003", "date": "09-18"},
  ],
